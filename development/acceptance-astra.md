...
is reused, with independently authorized Claude work preserved.
...
- Unavailable Astra controls produce a truthful partial result only when Claude
...
behavioral proof. test_answer_contract.py tests the Claude adapter, not Astra
